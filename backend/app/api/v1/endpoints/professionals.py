...
async def list_professionals(
    ...
    professionals = await professional_service.list_professionals(skip=skip, limit=limit)
...
async def get_professional(
    ...
    try:
        ...
        raise HTTPException(status_code=status.HTTP_400_BAD_REQUEST, detail="Invalid professional ID format")
...
@router.post("/{professional_id}/skills", response_model=ProfessionalSkillResponse, status_code=status.HTTP_201_CREATED)
...
@router.delete("/{professional_id}/skills/{skill_id}", status_code=status.HTTP_204_NO_CONTENT)

...
class ReviewRepository:
    ...
    def get_by_id(self, review_id: UUID) -> Optional[Review]:
        ...
        return self.db.query(Review).filter(
            and_(Review.id == review_id, Review.deleted_at.is_(None))
        ).first()
    ...
    def list_reviews(self, skip: int = 0, limit: int = 20, include_deleted: bool = False) -> List[Review]:
    ...
    def get_reviews_by_project(self, project_id: UUID, skip: int = 0, limit: int = 20) -> List[Review]:
    ...
    def get_reviews_by_reviewer(self, reviewer_id: UUID, skip: int = 0, limit: int = 20) -> List[Review]:
    ...
    def get_reviews_by_reviewed(self, reviewed_id: UUID, skip: int = 0, limit: int = 20) -> List[Review]:
    ...
    def get_reviews_by_type(self, review_type: ReviewType, skip: int = 0, limit: int = 20) -> List[Review]:
        """Get reviews by type."""
        return self.db.query(Review).filter(
            and_(
    ...
    def get_review_by_project_and_reviewer(self, project_id: UUID, reviewer_id: UUID) -> Optional[Review]:

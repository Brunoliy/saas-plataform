...
class ProposalRepository:
    ...
    def get_by_id(self, proposal_id: UUID) -> Optional[Proposal]:
        ...
        return self.db.query(Proposal).filter(
            and_(Proposal.id == proposal_id, Proposal.deleted_at.is_(None))
        ).first()

    def update(self, proposal_id: UUID, proposal_data: ProposalUpdate) -> Optional[Proposal]:
        """Update proposal."""
    ...
    def list_proposals(self, skip: int = 0, limit: int = 20, include_deleted: bool = False) -> List[Proposal]:
    ...
    def get_proposals_by_project(self, project_id: UUID, skip: int = 0, limit: int = 20) -> List[Proposal]:
    ...
    def get_proposals_by_professional(self, professional_id: UUID, skip: int = 0, limit: int = 20) -> List[Proposal]:
    ...
    def get_proposals_by_status(self, status: ProposalStatus, skip: int = 0, limit: int = 20) -> List[Proposal]:
    ...
    def get_proposal_by_project_and_professional(self, project_id: UUID, professional_id: UUID) -> Optional[Proposal]:
